...
## Example
This is an example showing you an hypatia run for Afghanistan on all 22 states but
with a simple model for the infection

```{r, hypatia_example, echo = FALSE}
options(warn = - 1) 
  R0 <- 2
  timestep <- 100
  dt <- 1
  ...
  out <- hypatia::run_simulation("Afghanistan", R0, timestep, dt, time_period,
  ...
  strname <- paste("Individual SQUIRE Model Simulation")
